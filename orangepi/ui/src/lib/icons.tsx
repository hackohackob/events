 ...
 * Icons, drawn inline.
 *
 * The dashboard uses lucide; pulling that dependency onto an appliance that has
 * to boot from an SD card and serve one page over a hotspot is not worth it for
 * a dozen glyphs. These are the same 24×2 stroke geometry, so the two screens
