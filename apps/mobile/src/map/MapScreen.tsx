...
export function MapScreen({ viewMode }: { viewMode: AppViewMode }) {
  ...
  // connection at all. The background task doesn't run while the app is
  // foregrounded either, which is what we want: the unread badge above covers
  // that case. See event-chat.service.ts → pushChatNotification.
